...
public class VendaService {
    ...
    public void insertAsync(VendaRequestDTO venda) {
    ...
    public VendaResponseDTO insert(VendaRequestDTO venda) {
        ...
        call.enqueue(new Callback<VendaResponseDTO>() {
            ...
            public void onFailure(Call<VendaResponseDTO> call, Throwable t) {
                ...
                JOptionPane.showMessageDialog(null, "Tempo esgotado! Tente novamente mais tarde.\n\n" + t.getMessage(), "Erro ao finalizar venda", JOptionPane.ERROR_MESSAGE);
            }
        });

        if (throwable[0] != null) {
            JOptionPane.showMessageDialog(null, "Um erro ocorreu ao finalizar a venda:\n\n" + throwable[0].getMessage(), "Erro ao finalizar venda", JOptionPane.ERROR_MESSAGE);
        }

        JOptionPane.showMessageDialog(null, "Venda processada com sucesso!", "Sucesso", JOptionPane.INFORMATION_MESSAGE);
        return vendaDTO[0];
    }
