...
public class JpanelConsultaCliente extends javax.swing.JPanel {
    ...
    public JpanelConsultaCliente() throws ApiException, InterruptedException {
        initComponents();
        atualizarLista();
    }
    ...
    private void atualizarLista() throws ApiException, InterruptedException {
        List<ClienteDTO> listaClientes = new ClienteService()
                .findAll(GlobalVariables.acessToken);
