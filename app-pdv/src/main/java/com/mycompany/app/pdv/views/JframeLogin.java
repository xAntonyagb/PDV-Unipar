...
public class JframeLogin extends javax.swing.JFrame {
    ...
    private void btEntrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEntrarActionPerformed
        ...
        if(usuario.trim().isEmpty() && senha.trim().isEmpty()){
            ...
            JOptionPane.showMessageDialog(this, "Os campos de usuário e a senha devem ser preenchidos!", "Erro de Login", JOptionPane.ERROR_MESSAGE);
            return;
        }
        else if (usuario.trim().isEmpty()) {
            txtUsuario.setBorder(bordaErro);
            JOptionPane.showMessageDialog(this, "Por favor informe o usuário.", "Erro de Login", JOptionPane.ERROR_MESSAGE);
            return;
        }
        else if (senha.trim().isEmpty()) {
            txtSenha.setBorder(bordaErro);
            JOptionPane.showMessageDialog(this, "Por favor informe a senha.", "Erro de Login", JOptionPane.ERROR_MESSAGE);
            return;
        }
        
        realizarSignIn(usuario, senha);
