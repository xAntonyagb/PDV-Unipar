...
public class Venda {
    ...
    public Venda(int id, String observacao, Timestamp data, double valorTotal, double valorSubtotal, double descontoTotal, Cliente cliente, List<ItemVenda> itensVenda) {
        this.id = id;
